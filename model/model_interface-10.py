...
reco_prompt_history = """Similar user {i}: He/She has watched {SimilarHistory}. Based on this, He/she chose {SimilarChoice} to watch next. \n"""
...
class MInterface(pl.LightningModule):
    ...
    def score_demo(self, input):
        ...
        try:
            ...
            # 提取排序后前 5 个评分对应的索引
            top_5_idx = [data_list.index(item) for item in sorted_data_list[:10]]
